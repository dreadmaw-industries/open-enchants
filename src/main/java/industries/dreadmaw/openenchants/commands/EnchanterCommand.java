...
public class EnchanterCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        inv.setItem(11, new ItemStack(Material.STAINED_GLASS_PANE, 1, DyeColor.WHITE.getData()));
        inv.setItem(12, new ItemStack(Material.STAINED_GLASS_PANE, 1, DyeColor.GREEN.getData()));
        inv.setItem(13, new ItemStack(Material.STAINED_GLASS_PANE, 1, DyeColor.LIGHT_BLUE.getData()));
        inv.setItem(14, new ItemStack(Material.STAINED_GLASS_PANE, 1, DyeColor.YELLOW.getData()));
        inv.setItem(15, new ItemStack(Material.STAINED_GLASS_PANE, 1, DyeColor.ORANGE.getData()));
